...
# ==========================================
# 1. ПІДГОТОВКА ДАНИХ (МІСТА)
# ==========================================
# Список центрів повітів
data = [
    {"name": "Золотоніський", "lat": 49.6689, "lon": 32.0475},
    {"name": "Гадяцький",     "lat": 50.3678, "lon": 33.9797}, 
